...
public class DeleteFolderServlet extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(filePath.equals(currentMagit.getActiveRepository().getM_Location())){
            out.println(gson.toJson(new FileActionStatus(false, filePath, "You cannot delete the repository!")));
        }
        else {
            Deleter.deleteDir(filePath);
