...
import dataFromServlet.IsWcClean;
import logic.MAGit;
...
public class IsWcCleanServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println(gson.toJson(new IsWcClean(!currentMagit.checkIfThereAreOpenChanges())));
    }
